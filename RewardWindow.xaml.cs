        ...
        public void loadTextData(string name, string plat, string primeSetPlat, string ducats, string volume, bool vaulted, bool mastered, string owned, int partNumber, bool resize = true, bool hideReward = false)
        {
            ...
            switch (partNumber)
            {
                case 0:
                    ...
                    firstSetPlatText.Text = "全套价格: " + primeSetPlat;
                    firstDucatText.Text = ducats;
                    firstVolumeText.Text = "48小时内售出" + volume + "件";
                    firstVaultedMargin.Visibility = vaulted ? Visibility.Visible : Visibility.Hidden;
                    firstOwnedText.Text = owned.Length > 0 ? (mastered ? "✓ " : "") + owned + " 已拥有" : "";
                    if (resize)
                        Width = 251;
                    break;
                ...
                case 1:
                    ...
                    secondSetPlatText.Text = "全套价格: " + primeSetPlat;
                    secondDucatText.Text = ducats;
                    secondVolumeText.Text = "48小时内售出" + volume + "件";
                    secondVaultedMargin.Visibility = vaulted ? Visibility.Visible : Visibility.Hidden;
                    secondOwnedText.Text = owned.Length > 0 ? (mastered ? "✓ " : "") + owned + " 已拥有" : "";
                    if (resize)
                        Width = 501;
                    break;
                ...
                case 2:
                    ...
                    thirdSetPlatText.Text = "全套价格: " + primeSetPlat;
                    thirdDucatText.Text = ducats;
                    thirdVolumeText.Text = "48小时内售出" + volume + "件";
                    thirdVaultedMargin.Visibility = vaulted ? Visibility.Visible : Visibility.Hidden;
                    thirdOwnedText.Text = owned.Length > 0 ? (mastered ? "✓ " : "") + owned + " 已拥有" : "";
                    if (resize)
                        Width = 751;
                    break;
                ...
                case 3:
                    ...
                    fourthSetPlatText.Text = "全套价格: " + primeSetPlat;
                    fourthDucatText.Text = ducats;
                    fourthVolumeText.Text = "48小时内售出" + volume + "件";
                    fourthVaultedMargin.Visibility = vaulted ? Visibility.Visible : Visibility.Hidden;
                    fourthOwnedText.Text = owned.Length > 0 ? (mastered ? "✓ " : "") + owned + " 已拥有" : "";
                    if (resize)
                        Width = 1000;
                    break;
